...
<td><a href="javacript:" onclick="EditItem({{ $category->id }})" id="btnEdit-{{ $category->id }}"><span class="ion ion-md-build"></span></a>
    <a href="javacript:" onclick="SaveEditItem({{ $category->id }})" hidden id="btnSave-{{ $category->id }}"><span class="ion ion-md-save"></span></a>
<a href="admin/category/delete/{{ $category->id }}"><span class="ion ion-md-trash"></span></a></td>
